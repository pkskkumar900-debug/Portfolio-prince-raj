      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="relative p-6 bg-white/[0.02] border border-white/10 rounded-full shadow-[0_0_30px_rgba(6,182,212,0.15)]"
          >
        ...
        <div className="flex-1 space-y-6 text-center md:text-left">
          <motion.h2 
            variants={itemVariants}
            className="text-3xl md:text-4xl font-bold text-white tracking-wide drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]"
          >
            About Me
          </motion.h2>
