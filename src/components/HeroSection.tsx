  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      <div className="container px-4 md:px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1 text-sm font-medium text-amber-500 dark:text-amber-300 backdrop-blur-sm mb-4">
          ...
          <div className="relative" style={{ perspective: 1000 }}>
            ...
            >
              ...
              <span className="relative text-3d-blue-texture dark:text-3d-blue-texture">
                Hii I am Prince Raj | Ai developer
              </span>
            </motion.h1>
          </div>
          ...
          <p className="text-lg md:text-xl dark:text-gray-400 text-slate-600 max-w-[700px] drop-shadow-md mt-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto pt-4">
            <a href="#credentials" className="group relative inline-flex items-center justify-center px-8 py-3.5 text-base font-bold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 overflow-hidden shadow-lg">
            ...
            <a href="#contact" className="group relative inline-flex items-center justify-center px-8 py-3.5 text-base font-bold dark:text-white text-slate-900 transition-all duration-200 bg-transparent border dark:border-gray-700 border-gray-300 rounded-full dark:hover:bg-gray-800 hover:bg-gray-100 dark:hover:border-gray-600 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600 backdrop-blur-sm shadow-sm">
              <span className="relative flex items-center">
